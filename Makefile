...
.PHONY: audit 
audit: audit-nancy audit-vulncheck ## Run audit checks against the code

.PHONY: audit-nancy
audit-nancy: ## Run nancy audit checks against the code
	go list -m all | nancy sleuth

.PHONY: audit-vulncheck
audit-vulncheck: ## Run vulncheck audit checks against the code
	dis-vulncheck
